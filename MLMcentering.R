...
# import data
df1<- read_excel("dataset.xlsx",sheet="Sheet1")
# get an overview
str(df1)
...
######## table 2
# prepare the data
df2<- read_excel("dataset.xlsx",sheet = "Sheet2")
str(df2)
...
# explained individual-level variances are roughly equal
# explained group-level variances are smaller in cgm than in cwc
...
# intercepts (and explained variances at l2) are roughly equal

# table 4
# prepare the data
df3<- read_excel("dataset.xlsx",sheet = "Sheet3")
str(df3)
